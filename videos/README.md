...
- `astronaut-cinematic.mp4` — About Me + thank-you cinematic background (Mixkit)
- `astronaut-poster.jpg` — About / thank-you poster / reduced-motion fallback
- `projects-nature-cinematic.mp4` — Projects section soft rain + evening light plate (Mixkit)
